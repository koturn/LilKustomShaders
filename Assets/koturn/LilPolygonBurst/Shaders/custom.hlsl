...
#define LIL_CUSTOM_PROPERTIES \
    float _PolygonCrackWidth; \
    float4 _PolygonCrackColor; \
    float _PolygonRevivalTime; \
    float _PolygonRetentionTime; \
    float _PolygonCrackTime; \
    float _PolygonFillTime; \
    float _PolygonBurstTime; \
    float _PolygonDisappearTime; \
    float _PolygonMoveSpeed; \
    float _PolygonRotSpeed; \
