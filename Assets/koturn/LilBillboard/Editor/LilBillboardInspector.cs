...
namespace Koturn.LilBillboard.Editor
{
    /// <summary>
    /// <see cref="ShaderGUI"/> for the custom shader variations of "koturn/LilBillboard".
    /// </summary>
    public sealed class LilBillboardInspector : lilToonInspector
    {
        /// <summary>
        /// Name of this custom shader.
        /// </summary>
        public const string ShaderName = "koturn/LilBillboard";
        ...
        /// <summary>
        /// <see cref="MaterialProperty"/> of "_BillboardMode".
        /// </summary>
        private MaterialProperty _billboardMode;
        /// <summary>
        /// <see cref="MaterialProperty"/> of "_BillboardRotation".
        /// </summary>
        private MaterialProperty _billboardRotation;
        /// <summary>
        /// <see cref="MaterialProperty"/> of "_BillboardScale".
        /// </summary>
        private MaterialProperty _billboardScale;
        ...
        protected override void DrawCustomProperties(Material material)
        {
            ...
            using (new EditorGUILayout.VerticalScope(boxOuter))
            {
                ...
                using (new EditorGUILayout.VerticalScope(boxInnerHalf))
                {
                    ...
                    lilEditorGUI.LocalizedProperty(me, _billboardMode);
                    lilEditorGUI.LocalizedProperty(me, _billboardRotation);
                    lilEditorGUI.LocalizedProperty(me, _billboardScale);
                }
            }
        }
